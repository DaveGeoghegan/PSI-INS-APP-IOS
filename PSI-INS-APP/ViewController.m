...
- (IBAction)tapExecutives:(id)sender {
  ...
  self.navigationController.navigationBarHidden = FALSE;
     NSURL *url = [NSURL URLWithString:@"https://ins.wiki.goto-psi.com/"];
...
- (IBAction)executivesButtonClicked:(UIButton *)sender {
   ...
   NSString *theURLString = @"";
    ...
    NSString *theWholeURL = @"https://ins.wiki.goto-psi.com/";
...
//       NSURL *url = [NSURL URLWithString:@"https://ins.wiki.goto-psi.com/fs-launchpad.html"];
////    NSURL *url = [NSURL URLWithString:@"https://ins.wiki.goto-psi.com/mobile-frame-ios-v2.html"];
//
//    NSURLRequest *urlReq = [NSURLRequest requestWithURL:url];
//
...
decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler
{
    ...
    if ([theURL containsString:@"ins.wiki.goto-psi.com/"]) {
